...
const int LdrPin = D8;  // Pin analog untuk membaca sensor LDR
...
void loop() {
  ...
  Serial.println(" Lux");
  //--End Tambahan untuk sensor DS18B20 dan LDR
